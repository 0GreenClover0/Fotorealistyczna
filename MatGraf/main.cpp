...
int main()
{
    ...
    camera.verticalFov = 10.0f;
    camera.lookFrom = Vector(0.0f, 0.0f, 6.0f);
    ...
    std::shared_ptr<Sphere> sphere1 = std::make_shared<Sphere>(Vector(-2.1f, 0.0f, -2.0f), 2.0f, mat1);
    std::shared_ptr<Sphere> sphere2 = std::make_shared<Sphere>(Vector(2.1f, 0.0f, 0.0f), 2.0f, mat2);
